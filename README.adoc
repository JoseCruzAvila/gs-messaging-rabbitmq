...
With any messaging-based application, you need to create a receiverInitial that responds to
...
The message listener container and receiverInitial beans are all you need to listen for messages.
...
latch in the receiverInitial and closes the application context. The following listing (from
...
In tests, you can mock out the runner so that the receiverInitial can be tested in isolation.
